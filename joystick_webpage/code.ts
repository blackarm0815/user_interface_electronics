const resizeDivs = () => {
  ...
  const divJoystick = <HTMLDivElement>document.getElementById('joystick');
  if (divJoystick !== null) {
  ...
  const divLever = <HTMLDivElement>document.getElementById('lever');
  if (divLever !== null) {
...
const checkJoystick = (
  ...
  const joystick = <HTMLDivElement>document.getElementById('joystick');
...
const checkLever = (
  ...
  const lever = <HTMLDivElement>document.getElementById('lever');
