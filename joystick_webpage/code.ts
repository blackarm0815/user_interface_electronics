const resizeDivs = () => {
  ...
  const divJoystick = <HTMLDivElement>document.getElementById('joystick0');
  if (divJoystick !== null) {
  ...
  const divLever = <HTMLDivElement>document.getElementById('joystick1');
  if (divLever !== null) {
  ...
  const divOutput0 = <HTMLDivElement>document.getElementById('output0');
  if (divOutput0 !== null) {
  ...
  const divOutput1 = <HTMLDivElement>document.getElementById('output1');
  if (divOutput1 !== null) {
  ...
  const divOutput2 = <HTMLDivElement>document.getElementById('output2');
  if (divOutput2 !== null) {
  ...
  const divOutput3 = <HTMLDivElement>document.getElementById('output3');
  if (divOutput3 !== null) {
...
const checkJoystick0 = (
  touch: Touch,
) => {
  const joystick0 = <HTMLDivElement>document.getElementById('joystick0');
  const output0 = <HTMLDivElement>document.getElementById('output0');
  const output1 = <HTMLDivElement>document.getElementById('output1');
...
const checkJoystick1 = (
  touch: Touch,
) => {
  const joystick1 = <HTMLDivElement>document.getElementById('joystick1');
  const output2 = <HTMLDivElement>document.getElementById('output2');
  const output3 = <HTMLDivElement>document.getElementById('output3');
